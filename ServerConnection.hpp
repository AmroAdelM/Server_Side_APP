...
#define DEFAULT_PORT "27015"
	...
	int run_Server()
	{
		Serverlayer::server* obj = new Serverlayer::server();
		Serverlayer::ERROR_TYPE error = Serverlayer::ERROR_TYPE::NONE;
		...
		do {
			...
			if (iResult > 0) {
				...
				client_msg.load_string(recvbuf);
				std::string client_id = client_msg.child("client").attribute("id").value();
